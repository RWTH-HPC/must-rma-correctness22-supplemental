...
check_mpi_function_exists_pp(MPI_Win_create)
check_mpi_function_exists_pp(MPI_Win_allocate)
check_mpi_function_exists_pp(MPI_Win_allocate_shared)
check_mpi_function_exists_pp(MPI_Win_attach)
check_mpi_function_exists_pp(MPI_Win_c2f)
check_mpi_function_exists_pp(MPI_Win_call_errhandler)
check_mpi_function_exists_pp(MPI_Win_complete)
check_mpi_function_exists_pp(MPI_Win_create)
check_mpi_function_exists_pp(MPI_Win_create_dynamic)
check_mpi_function_exists_pp(MPI_Win_create_errhandler)
check_mpi_function_exists_pp(MPI_Win_create_keyval)
check_mpi_function_exists_pp(MPI_Win_delete_attr)
check_mpi_function_exists_pp(MPI_Win_detach)
check_mpi_function_exists_pp(MPI_Win_f2c)
check_mpi_function_exists_pp(MPI_Win_fence)
check_mpi_function_exists_pp(MPI_Win_flush)
check_mpi_function_exists_pp(MPI_Win_flush_all)
check_mpi_function_exists_pp(MPI_Win_flush_local)
check_mpi_function_exists_pp(MPI_Win_flush_local_all)
check_mpi_function_exists_pp(MPI_Win_free)
check_mpi_function_exists_pp(MPI_Win_free_keyval)
check_mpi_function_exists_pp(MPI_Win_get_attr)
check_mpi_function_exists_pp(MPI_Win_get_errhandler)
check_mpi_function_exists_pp(MPI_Win_get_group)
check_mpi_function_exists_pp(MPI_Win_get_info)
check_mpi_function_exists_pp(MPI_Win_get_name)
check_mpi_function_exists_pp(MPI_Win_lock)
check_mpi_function_exists_pp(MPI_Win_lock_all)
check_mpi_function_exists_pp(MPI_Win_post)
check_mpi_function_exists_pp(MPI_Win_set_attr)
check_mpi_function_exists_pp(MPI_Win_set_errhandler)
check_mpi_function_exists_pp(MPI_Win_set_info)
check_mpi_function_exists_pp(MPI_Win_set_name)
check_mpi_function_exists_pp(MPI_Win_shared_query)
check_mpi_function_exists_pp(MPI_Win_start)
check_mpi_function_exists_pp(MPI_Win_sync)
check_mpi_function_exists_pp(MPI_Win_test)
check_mpi_function_exists_pp(MPI_Win_unlock)
check_mpi_function_exists_pp(MPI_Win_unlock_all)
check_mpi_function_exists_pp(MPI_Win_wait)
check_mpi_function_exists_pp(MPI_Get)
check_mpi_function_exists_pp(MPI_Get_accumulate)
check_mpi_function_exists_pp(MPI_Rget)
check_mpi_function_exists_pp(MPI_Rget_accumulate)
check_mpi_function_exists_pp(MPI_Put)
check_mpi_function_exists_pp(MPI_Rput)
check_mpi_function_exists_pp(MPI_Accumulate)
check_mpi_function_exists_pp(MPI_Raccumulate)
check_mpi_function_exists_pp(MPI_Fetch_and_op)
check_mpi_function_exists_pp(MPI_Compare_and_swap)
