...
// CHECK: [MUST-REPORT] Information: from: call MPI_Initialized@1: Information on request: Persistent point-to-point request created at reference 1, activated at reference 2, canceled at reference 3
