...
//         posInfo(int index, int count, MustAddressType e, MustAddressType a, MustAddressType na, MustAddressType ne, const char* name):index(index), count(count), errorpos(getAddressVector(e,ne,MAXDOTSIBLINGS)), erroradd(getAddressVector(a,na,MAXDOTSIBLINGS)), name(name){}
    ...
    public:
        ...
        void addReference(MustParallelId pId, MustLocationId lId){++mpiReferences; references[std::make_pair(pId, lId)]++;}
        ...
        bool isSimpleArray(void) const {return simpleArray;}
        virtual MustMpiDatatypeClass getDatatypeClass(void) const {return datatypeClass;}
        ...
        */
         ...
         */
        std::vector<I_Datatype*> getParentTypes();
