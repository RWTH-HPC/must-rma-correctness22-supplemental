...
namespace must
{
	...
	template <
		...
		>
	class TrackBase : public gti::ModuleBase<SUPER, INTERFACE, false>, public virtual must::I_TrackBase<I_INFO>
	{
	public:
		/**
		 * Constructor.
	...
	protected:
		...
		sf::contfree_safe_ptr<PredefinedInfos> myPredefineds; /**< Used to identify named constants, initialized by addPredefineds. */
...
//		sf::contfree_safe_ptr< PredefinedMap> myPredefinedMap;
		sf::contfree_safe_ptr< HandleMap> myUserHandles; /**< User-defined types.*/
                typename HandleMap::const_iterator
                    myLastQuery; /** Used to speed up repeated queries for the
                                    same handle. */
                sf::contfree_safe_ptr<RemoteMap> myRemoteRes; /**< Resources from remote places on the same level.*/
		 ...
		 */
                typename HandleMap::const_iterator
                findUserHandle(MustParallelId pId, HANDLE_TYPE handle);
		 ...
		 */
                typename HandleMap::const_iterator
                findUserHandle(int rank, HANDLE_TYPE handle);
                 ...
                 */
                bool submitUserHandle(MustParallelId pId, HANDLE_TYPE handle,
                 ...
                 * pId.
                 */
                bool submitUserHandle(int rank, HANDLE_TYPE handle,
                                      FULL_INFO *handleInfo);
                 ...
                 * @return true if successful, false otherwise.
                 */
                bool submitRemoteResource(int rank, MustRemoteIdType remoteId,
                                          bool hasHandle, HANDLE_TYPE handle,
                                          FULL_INFO *handleInfo);
