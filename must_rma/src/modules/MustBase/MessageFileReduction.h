 ...
 */
class MessageFileReduction
    : public gti::ModuleBase<MessageFileReduction, I_MessageFileReduction>
{
  public:
    /**
     * Constructor.
    ...
    changeMessageFile(size_t fileId, const char *filename, size_t len);

    /**
     * @see I_MessageFileReduction::changeMessageFileWrapper
     */
    gti::GTI_ANALYSIS_RETURN
    changeMessageFileWrapper(const char *filename);
