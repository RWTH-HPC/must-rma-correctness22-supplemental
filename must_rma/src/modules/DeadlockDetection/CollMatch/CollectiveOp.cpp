...
bool CollectiveOp::printCollectiveMismatch (CollectiveOp *other)
{
    ...
    myMatcher->myLogger->createMessage(MUST_ERROR_COLLECTIVE_CALL_MISMATCH, myPId, myLId,
...
bool CollectiveOp::printRootMismatch (CollectiveOp *other)
{
    ...
    myMatcher->myLogger->createMessage(MUST_ERROR_COLLECTIVE_ROOT_MISMATCH, myPId, myLId,
                                       MustErrorMessage, stream.str(), references);
...
bool CollectiveOp::printOpMismatch (CollectiveOp *other)
{
    ...
    myMatcher->myLogger->createMessage(MUST_ERROR_COLLECTIVE_OP_MISMATCH, myPId, myLId,
                                       MustErrorMessage, stream.str(), references);
