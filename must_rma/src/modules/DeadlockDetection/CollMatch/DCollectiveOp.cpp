...
bool DCollectiveOp::printCollectiveMismatch (DCollectiveOp *other)
{
    ...
    myMatcher->getLogger()->createMessage(MUST_ERROR_COLLECTIVE_CALL_MISMATCH, myPId, myLId,
                                          MustErrorMessage, stream.str(), references);
...
bool DCollectiveOp::printRootMismatch (DCollectiveOp *other)
{
    ...
    myMatcher->getLogger()->createMessage(MUST_ERROR_COLLECTIVE_ROOT_MISMATCH, myPId, myLId,
                                          MustErrorMessage, stream.str(), references);
...
bool DCollectiveOp::printOpMismatch (DCollectiveOp *other)
{
    ...
    myMatcher->getLogger()->createMessage(MUST_ERROR_COLLECTIVE_OP_MISMATCH, myPId, myLId,
                                          MustErrorMessage, stream.str(), references);
...
bool DCollectiveOp::printBlockingNonBlockingMismatch (DCollectiveOp *other)
{
    ...
    myMatcher->getLogger()->createMessage(MUST_ERROR_COLLECTIVE_BLOCKING_NONBLOCKING_MISMATCH,
                                          woRequest->myPId, woRequest->myLId, MustErrorMessage,
                                          stream.str(), references);
