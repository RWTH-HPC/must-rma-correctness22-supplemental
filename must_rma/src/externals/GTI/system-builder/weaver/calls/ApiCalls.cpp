...
{
	std::string name, wrappEverywhereString, wrappAcrossString, wrappDownString, isFinalizerString, returnType, isNotifyFinalizeString, isOutOfOrderString, isCallbackString, isAnnotationString, isHookString;
